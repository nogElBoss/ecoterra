...
export default async function handler(req, res) {
    ...
    try {
        ...
        const query = 'SELECT DISTINCT sci_name, class, category, marine FROM all_species WHERE ST_Intersects(ST_SetSRID(ST_MakeLine(ST_MakePoint($1, $2),ST_MakePoint($1, $2)), 4326), geom) ;';
